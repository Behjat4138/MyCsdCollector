...
public class MyRegisterPage extends AppCompatActivity {
    ...
    EditText fullname, username, password, confirmpassword, email;
    ...
    public void register(View view) {
        ...
        if (name.equals("") || emx.equals("") || user.equals("") || pass.equals("") || confpass.equals("") )
                        ...
                        .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    UserClass u = new UserClass(userID, name, emx, user, pass);
